...
def create_enhanced_features(df):
    """Create enhanced features from historical data"""
    ...
    for idx, row in df.iterrows():
        ...
        # Division game advantage
        div_game = row.get('div_game', False)
        df.at[idx, 'div_game'] = div_game
        ...
        if (pd.notna(row['away_score']) and pd.notna(row['home_score']) and 
            ...
            try:
                ...
                if div_game:
                    team_stats[away_team]['div_games'] += 1
                ...
                if away_score > home_score:
                    ...
                    if div_game:
                        team_stats[away_team]['div_wins'] += 1
                else:
                ...
                if home_score > away_score:
                    ...
                    if div_game:
                        team_stats[home_team]['div_wins'] += 1
                else:
...
def train_enhanced_model(X_train, y_train):
    ...
    print("🤖 Training enhanced model on historical data...")
    ...
    print("\n📊 Enhanced Model Performance on Historical Data:")
    print("-" * 60)
...
def test_model_on_2025_data(model, X_2025, y_2025):
    ...
    print("🧪 Testing enhanced model on 2025 data...")
...
def main():
    ...
    # Create enhanced features for historical data
    historical_with_features = create_enhanced_features(historical_completed)
    ...
    print(f"✅ Prepared {len(X_train)} historical samples with {len(feature_columns)} enhanced features")
    
    # Train enhanced model on historical data
    model, historical_accuracy = train_enhanced_model(X_train, y_train)
    ...
    # Create enhanced features for 2025 data
    df_2025_with_features = create_enhanced_features(completed_2025)
    ...
    # Test enhanced model on 2025 data
