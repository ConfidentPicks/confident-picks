...
def create_test_pick_cards():
    ...
    print(f"\n{'='*80}")
    print("PUSHING TO FIREBASE TEST_PICKS COLLECTION")
    print(f"{'='*80}")
    ...
    for i, pick_card in enumerate(pick_cards, 1):
        try:
            ...
            print(f"   Reasoning Part 1: {pick_card['reasoning_part1']}")
            print(f"   Reasoning Part 2: {pick_card['reasoning_part2']}")
            print(f"   Reasoning Part 3: {pick_card['reasoning_part3']}")
            print()
