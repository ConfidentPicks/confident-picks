...
def create_enhanced_features(df):
    """Create enhanced features from actual data structure"""
...
def train_enhanced_model(historical_df):
    """Train the enhanced model with real data"""
...
def make_enhanced_predictions(model, df, feature_columns):
...
def main():
    ...
    print("-" * 70)
    model, feature_columns = train_enhanced_model(historical_df)
    ...
    print("-" * 70)
    predicted_winners, winner_confidences = make_enhanced_predictions(model, df_2025, feature_columns)
