...
"""
Add Predictions to Live Picks Sheet
==================================

This script adds prediction columns to live_picks_sheets and populates them
"""
...
class LivePicksPredictor:
    ...
    def add_prediction_columns(self):
        """Add prediction columns to live_picks_sheets"""
        try:
            print("\n📝 Adding prediction columns to live_picks_sheets...")
            ...
            print(f"✅ Added {len(new_columns)} prediction columns")
            return current_cols
    ...
    def update_predictions_batch(self, live_picks_df, predictions):
                ...
                if game_id in predictions:
                    ...
                    for col_name, col_idx in col_indices.items():
                        if col_name == 'predicted_winner':
                            ...
                            updates.append({'range': f"live_picks_sheets!{chr(65+col_idx)}{idx+2}", 'values': [[pred['model_last_updated']]]})
                    
                    print(f"  ✓ {matchup}: {pred['predicted_winner']} ({pred['confidence_score']:.1%} confidence)")
    ...
    def run_live_picks_predictions(self):
        """Run the live picks prediction system"""
        print("🏈 Live Picks Sheet Prediction System")
        print("=" * 60)
        ...
        self.update_predictions_batch(live_picks_df, predictions)
        
        print("\n" + "=" * 60)
        print("✅ Live picks prediction system complete!")
...
def main():
    ...
    # Initialize and run
    system = LivePicksPredictor(credentials_path, spreadsheet_id)
    system.run_live_picks_predictions()
