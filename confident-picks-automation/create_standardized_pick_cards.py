...
def create_standardized_pick_cards():
    """Create pick cards with standardized reasoning"""
    print("=" * 80)
    print("STANDARDIZED PICK CARDS FOR 10/26/2025")
    print("=" * 80)
    
    service = get_sheets_service()
    
    # Get game data and predictions for rows 111-122 (correct columns: H=away, J=home)
...
• Team Performance: {stats['moneyline']}% moneyline accuracy this season
• Signal Alignment: Model and performance both favor {predicted_winner}
            ...
            for team in [away_team, home_team]:
                if team in high_performers and team != predicted_winner:
                    ...
                    if spread_accuracy >= 50:
                        # Spread picks are always MEDIUM confidence due to conflicting signals
...
if __name__ == "__main__":
    create_standardized_pick_cards()
